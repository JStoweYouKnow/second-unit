...
/** Filled brand marks (social logos) — stroke-free for recognizability */
function BrandSvg({ size = 24, color = 'currentColor', className = '', style, children }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconX({ size = 24, color = 'currentColor', className = '', style } = {}) {
  return (
    <BrandSvg size={size} color={color} className={className} style={style}>
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </BrandSvg>
  )
}

export function Instagram({ size = 24, color = 'currentColor', className = '', style } = {}) {
  return (
    <BrandSvg size={size} color={color} className={className} style={style}>
...
export function LinkedIn({ size = 24, color = 'currentColor', className = '', style } = {}) {
  return (
    <BrandSvg size={size} color={color} className={className} style={style}>
      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-.678 0-1.23-.55-1.23-1.231A1.232 1.232 0 015.337 4.97c.68 0 1.232.55 1.232 1.232 0 .681-.552 1.231-1.232 1.231zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
    </BrandSvg>
  )
}
...
export function Trash2({ size = 24, color = 'currentColor', className = '', style } = {}) {
  return (
    <Svg {...p(size, color, className, style)}>
...
export function Sun({ size = 24, color = 'currentColor', className = '', style } = {}) {
  return (
    <Svg {...p(size, color, className, style)}>
      <circle cx="12" cy="12" r="4" />
...
export function Moon({ size = 24, color = 'currentColor', className = '', style } = {}) {
  return (
    <Svg {...p(size, color, className, style)}>
