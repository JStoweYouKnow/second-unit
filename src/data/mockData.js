...
export const artists = [
  {
    ...
    videoLinks: ['https://vimeo.com/353906642'],
  ...
  },
  {
    ...
    portfolio: [], videoLinks: ['https://www.youtube.com/watch?v=ScMzIvxBSi4'],
  ...
  },
  {
    ...
    portfolio: [], videoLinks: ['https://www.youtube.com/watch?v=pD3G-v_HhOQ'],
  ...
  },
  {
    ...
    portfolio: [], videoLinks: ['https://vimeo.com/835084110'],
    socials: { twitter: '#', instagram: '#', website: '#', linkedin: '#' },
...
export const bookings = [
  { id: 1, artistId: 1, artistName: 'Maya Chen', date: '2026-04-25', time: '10:00', duration: 2, durationUnit: 'hours', status: 'confirmed', type: 'Consultation', agreedTotal: 500 },
  { id: 2, artistId: 4, artistName: 'Dex Okafor', date: '2026-04-23', time: '14:00', duration: 2, durationUnit: 'days', status: 'pending', type: 'Project Work', agreedTotal: 4480 },
  { id: 3, artistId: 6, artistName: 'Theo Park', date: '2026-04-24', time: '10:00', duration: 1, durationUnit: 'project', status: 'confirmed', type: 'Full project', agreedTotal: 9600 },
];
