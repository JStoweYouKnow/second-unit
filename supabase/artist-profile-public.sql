-- Dedicated public profile header image + Artist Database listing toggle.
...
comment on column public.artists.is_public is
  'When false, artist is hidden from the Artist Database and public discovery (direct link still works for owner).';
