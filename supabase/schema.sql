...
-- =============================================
-- Runs as postgres (definer) so inserts succeed under RLS; stable search_path avoids hijack + type errors.
...
declare
  ...
  display_name text;
begin
  -- Never trust client-supplied admin; only employer or artist from signup metadata.
